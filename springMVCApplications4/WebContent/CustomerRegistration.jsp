...
<table>
<tr><td>Enter First name:<sf:input type ="text" path= "firstName"></sf:input> <sf:errors path="firstName"></sf:errors></td>
<tr><td>Enter last name:<sf:input type ="text" path= "lastName"></sf:input> <sf:errors path="lastName"></sf:errors></td>
<tr><td>Enter age:<sf:input type ="text" path= "age"></sf:input> <sf:errors path="age"></sf:errors></td> 
<tr><td>Enter mobile number:<sf:input type ="text" path= "mobileNo"></sf:input>  <sf:errors path="mobileNo"></sf:errors></td>
